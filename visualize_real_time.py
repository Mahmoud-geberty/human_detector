...
while True:
    ...
    for im_scaled in pyramid_gaussian(image, downscale = downscale):
        ...
        for (x, y, window) in sd.sliding_window(im_scaled, size, step_size):
            ...
            fd=hog(window, block_norm='L2-Hys',orientations=9,pixels_per_cell=(8,8),visualize=False,cells_per_block=(2,2))
            fd = fd.reshape(1, -1)
    ...
    print("done calc and waiting for button press")
    if cv2.waitKey(1)==27:
        break
cap.release()
